namespace CollectionManagement.Infrastructure.Services.CustomFields;
  ...
  : ICustomFieldService
{
  ...
  public async Task<bool> CreateCustomFieldAsync(int id, CustomFieldDto customFieldDto, CancellationToken cancellationToken = default)
  {
