namespace CollectionManagement.Presentation.Controllers.Collections;
  ...
  : Controller
{
  ...
  public async Task<IActionResult> Index()
  {
    ...
    var result = await _userService.GetPagedCollectionsAsync(new PaginationParams(1, _pageSize));
    return View(result);
  }
